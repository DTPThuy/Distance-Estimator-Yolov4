...
ref_person = cv.imread('ReferenceImages/image2.png')
ref_chair = cv.imread('ReferenceImages/image3.jpg')
...
print(
    f"Person width in pixels : {person_width_in_rf} mobile width in pixel: {mobile_width_in_rf} chair width in pixel: {chair_width_in_rf}")
...
while True:
    ...
    for d in data:
        if d[0] =='person':
            ...
            distance = distance_finder(focal_chair, MOBILE_WIDTH, d[1])
            x, y = d[2]
